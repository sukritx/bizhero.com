        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-[700px] text-center">
            ...
            <p className="text-lg text-gray-600">
              We provide maintenance services that help businesses reduce downtime and extend equipment life.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              <div key={i} className="group rounded-xl border border-gray-200 bg-white p-8 shadow-sm transition hover:shadow-lg">
                ...
                <p className="mb-4 text-base leading-relaxed text-gray-600">{service.description}</p>
                <Link
                  href={service.href}

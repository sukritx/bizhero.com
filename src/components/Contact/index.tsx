        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[150px]">
                <span className="mb-6 block text-base font-medium text-dark dark:text-white">{t("contact.contactUs")}</span>
                <h2 className="max-w-[360px] text-[35px] font-semibold leading-[1.14] text-dark dark:text-white">{t("contact.headline")}</h2>
              </div>
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    <h3 className="mb-[18px] text-lg font-semibold text-dark dark:text-white">{t("contact.ourLocation")}</h3>
                    <p className="text-base text-body-color dark:text-dark-6">{t("contact.locationDesc")}</p>
                  </div>
                </div>
                <div className="mb-8 flex w-[330px] max-w-full">
                  <div className="mr-6 text-[32px] text-primary">
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
            <div className="wow fadeInUp rounded-lg bg-white px-8 py-10 shadow-testimonial dark:bg-dark-2 dark:shadow-none sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]" data-wow-delay=".2s">
              <h3 className="mb-8 text-2xl font-semibold text-dark dark:text-white md:text-[28px] md:leading-[1.42]">{t("contact.getQuote")}</h3>
              <p className="mb-8 text-base leading-relaxed text-body-color dark:text-dark-6">{t("contact.quoteDesc")}</p>
              <Link href="https://share-na2.hsforms.com/283IRhHVgQLuB-uFLk7V9cQ40ae96" className="inline-flex w-full items-center justify-center bg-primary px-10 py-3 text-base font-bold text-white transition duration-300 ease-in-out hover:bg-primary/90">
                {t("contact.getQuote")}
              </Link>
            </div>
          </div>

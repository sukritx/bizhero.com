...
const serviceIcons = [
  ...
  (<svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2" /></svg>),
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {services.map((service, i) => (
            <div key={i} className="group rounded-xl border border-gray-200 bg-white p-8 shadow-sm transition hover:shadow-lg">
              ...
              <h3 className="mb-3 text-xl font-bold text-gray-900">{t(service.titleKey)}</h3>
              <p className="mb-4 text-base leading-relaxed text-gray-600">{t(service.descKey)}</p>
              <Link href={service.href} className="inline-flex items-center text-sm font-semibold text-primary transition hover:text-primary/80">

          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link href="/" className="mb-6 inline-block">
                <span className="text-xl font-bold text-dark">A-1 Total Service Plumbing</span>
              </Link>
              <p className="mb-8 max-w-[270px] text-base text-gray-800">
                Licensed, bonded, and insured plumbing company serving Los Angeles County and Orange County since 2004. CA License #1135475.
              </p>
           ...
           <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
             <div className="mb-10 w-full">
               ...
               <p className="mb-6 text-base text-gray-800">
                 24/7 emergency plumbing available. Get a free estimate from our licensed professionals today.
               </p>
               <a
                 href="tel:3234102068"
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                 <p className="text-base text-gray-600">
                   &copy; {new Date().getFullYear()} A-1 Total Service Plumbing. CA License #1135475. All rights reserved.
                 </p>
              </div>
            </div>
          </div>

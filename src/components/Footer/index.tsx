          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="-mx-3 flex items-center">
                <Link aria-label="Facebook" href="https://www.facebook.com/" className="px-3 text-gray-600 hover:text-primary">
                ...
                <Link aria-label="Instagram" href="https://www.instagram.com/" className="px-3 text-gray-600 hover:text-primary">
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                ...
                <Link aria-label="LinkedIn" href="https://www.linkedin.com/" className="px-3 text-gray-600 hover:text-primary">
